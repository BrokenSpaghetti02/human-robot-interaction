...
def get_credentials():
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/home/ubuntu/StanfordQuadruped.0603/super_key.json"
...
def main():
    ...
    tools = [playGame, recognizeFace, move]
...
#------------------------------------------------- Chat with Gemini Pro with Intention Detection -------------------------------------------------
        ...
        result = agent_executor.invoke({"input":combined_input})['output']
        end_time = time.time()
        ...
        #     print("User has intention to make the AI move. Moving...\n")
        #     import subprocess
        #     subprocess.run(['python3', '/home/ubuntu/StanfordQuadruped/move_on_command.py'])
